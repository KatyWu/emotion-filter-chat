...
步驟一：判斷是否為被動攻擊
如果整句是被動攻擊（例：隨便啊你開心就好、算了你不會懂、隨便），把它改寫成直接表達當下負面情緒的句子，例如「我現在很不高興」、「我覺得很受傷」，語氣口語自然。
...
If the whole message is passive-aggressive (e.g. "whatever", "fine, do what you want", "forget it"), rewrite it as a direct expression of the negative emotion, e.g. "I'm really upset right now", "I feel hurt". Keep it casual and natural.
...
function JoinScreen({ onJoin }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", minHeight: "-webkit-fill-available", background: "#0f0f0f", fontFamily: "'DM Sans', 'Noto Sans TC', sans-serif" }}>
...
const unsubLeave = onChildRemoved(presenceRoomRef.current, (snapshot) => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: "-webkit-fill-available", background: "#0f0f0f", fontFamily: "'DM Sans', 'Noto Sans TC', sans-serif" }}>
